...
const options = {
    ...
    title: 'Success',
    message: 'Created!',
    detail: 'Successfully created transit.',
};
...
createBtn.addEventListener("click", function() {
  ...
  var newtransit = transportType.value;
  ...
  }, transitRoute, newtransit, newroute, newprice, sitesList, error);
  event.preventDefault();
...
function editTransit(callback, oldroute, oldtype, newroute, newprice, sitesList, error) {
  ...
  // Perform a query
  $queryLog = 'CALL create_transit("'+oldtype+'", "'+newroute+'", "'+newprice+'")';
